...
import { addUser, changePassword, forgetPassword, getUserDetils, getUserInfo, login, setSettingByAdmin, updateUser, userLogout, verfiyemail } from '../controller/user.controller.js';
...
router.patch('/setting/' , auth , rolles(['admin']) ,setSettingByAdmin)
